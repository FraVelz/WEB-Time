  ...
  const countdowns: CountdownItem[] = [
    {
      ...
      description: "Cual es la etapa donde una persona obtiene total responsabilidad legal? hubiera deseado tener buena tierra para no tener que labrarla.",
    ...
    },
    {
      ...
      description: "que necesita un futbolista para ser de los mejores? deseo ya tener una red compleja de raíces debajo de la tierra como neuronas en el cerebro.",
    ...
    },
    {
      ...
      description: "Al final que necesita un cantante para lograr el éxito? comienza a surgir el brote de la tierra y a crecer rápidamente.",
    ...
    },
    {
      ...
      description: "Es posible que todos te quieran? la planta comienza a dar sombra, pero comienza a molestar a otras plantas con sus raices.",
    ...
    },
    {
      ...
      description: "Cual es el problema de que alguien disfrute del fruto de su trabajo? los frutos comienzan a surgir y todo parece felicidad.",
    ...
    },
    {
      ...
      description: "hay cosas realmente necesarias o solo son interés personal? Inicio del año 2045 (medianoche en Colombia) - El árbol crece tanto que necesita mas espacio para crecer.",
    ...
    },
    {
      ...
      description: "Como caen las potencias históricamente? las ramas han crecido tanto que comienza a caer solas (la historia se repite, pero los tiempos cambian)",
    ...
    },
    {
      ...
      description: "Acaso he disfrutado de la vida?, no lo se, pero si que he llegado lejos - el árbol deja semillas para el futuro en cualquier momento llagara su hora",
    ...
    },
    {
      id: "nueva-mision",
      title: "Nueva mision",
      description: "La ambision es mental, espero que sepas y recuerdes cual es el siguiente paso, siempre sera ayudar a los demás granjeros, a lograr lo que tu has aprendido lograr, nunca pierdas la humildad y aunque fueras el ejemplo para muchos, hay cosas que se pueden aprender de los demás.",
